...
PROMPT_V1_NAME = "dang-tien-thanh-rag-prompt-v1"
PROMPT_V2_NAME = "dang-tien-thanh-rag-prompt-v2"


# ── 2. Định nghĩa 2 Prompt Templates ──────────────────────────────────────
SYSTEM_V1 = (
    "You are a helpful AI assistant. Answer the question in 2-4 concise "
    "sentences using only the supplied context. If the context does not "
    "contain enough information, say that the information was not found. "
...
SYSTEM_V2 = (
    "You are an AI subject-matter expert. Analyze the supplied context and "
    "produce a structured 3-5 sentence answer with: (1) the direct answer, "
    "(2) supporting facts from the context, and (3) a brief confidence note. "
    "Use only the context, do not speculate, and explicitly state when the "
...
def push_prompts_to_hub(client: Client):
    ...
    try:
        url = client.push_prompt(
            PROMPT_V2_NAME,
            object=PROMPT_V2,
            description="V2 - structured expert answers with confidence",
        )
